...
def _main():
    parser = argparse.ArgumentParser(description="Equilibrium simulation")
    ...
    parser_gen.add_argument(
        "-e", "--ensemble", type=str, help="the ensemble of the simulation"
    )
    parser_gen.add_argument(
        "-t", "--temperature", type=float, help="the temperature of the system"
    )
    parser_gen.add_argument(
    ...
    parser_stat.add_argument("JOB", type=str, help="folder of the job")
    parser_stat.add_argument(
        "-s", "--skip", type=int, default=1, help="skip this number of frames"
    )
